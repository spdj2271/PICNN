...
from util.mypath import MyPath
...
class CIFAR10(Dataset):
    ...
    def __init__(self, root=MyPath.db_root_dir('cifar-10'), train=True, transform=None,
        ...
        if type(self.train) == bool:
            if self.train:
                downloaded_list = self.train_list
            else:
                downloaded_list = self.test_list
        elif self.train == 'all':
            downloaded_train_list = self.train_list
            downloaded_test_list = self.test_list
            downloaded_list = downloaded_train_list + downloaded_test_list
        else:
